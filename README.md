...
```javascript
import nanmaxabs from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanmaxabs@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-nanmaxabs/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/stats-base-nanmaxabs/actions/workflows/test.yml?query=branch:v0.2.2
